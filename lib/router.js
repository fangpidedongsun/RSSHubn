...
//fangpidedongsun
router.get('/gov/beijing/renliziyuan', lazyloadRouteHandler('./routes/gov/beijing/renliziyuan'));
router.get('/gov/beijing/guojiarenliziyuan', lazyloadRouteHandler('./routes/gov/beijing/guojiarenliziyuan'));
router.get('/gov/beijing/miyungongkai', lazyloadRouteHandler('./routes/gov/beijing/miyungongkai'));
router.get('/gov/beijing/huairougongkai', lazyloadRouteHandler('./routes/gov/beijing/huairougongkai'));
router.get('/gov/beijing/shunyigongkai', lazyloadRouteHandler('./routes/gov/beijing/shunyigongkai'));
// 北京考试院
router.get('/gov/beijing/kaoshiyuan', lazyloadRouteHandler('./routes/gov/beijing/kaoshiyuan'));
//北京市文化和旅游局通知公告
router.get('/gov/beijing/bjwenhuaju', lazyloadRouteHandler('./routes/gov/beijing/bjwenhuaju'));
